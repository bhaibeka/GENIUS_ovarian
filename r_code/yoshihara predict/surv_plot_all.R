...
pdf(sprintf("/common/projects/trisch/Ovarian_cancer/plots/yoshihara/surv_allsets_%s.pdf", saveres), width=25, height=25)
...
for(j  in 1:length(saveres) ) {
   ...
   for(i  in 1:length(dataSets) ) {
      ...
      load(sprintf("/common/projects/trisch/Ovarian_cancer/%s/yoshihara_predict/%s.RData", dataSets[i], saveres) )
