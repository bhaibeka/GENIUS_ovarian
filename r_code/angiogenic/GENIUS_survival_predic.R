...
#INFO: You have to change the source for the prognostic signature, see 
...
setwd("/common/projects/trisch/Ovarian_cancer/tcga2011/genesig_stemlike_5mostvar_weighted_all_0630")
