...
pdf(sprintf("/common/projects/trisch/Ovarian_cancer/plots/forest_plot_%s.pdf", saveres), width=5, height=15)
...
cindex_summary <- combine.est(cindex_sum_all[,1],cindex_sum_all[,4])
