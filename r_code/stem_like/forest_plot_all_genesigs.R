...
pdf(sprintf("/common/projects/trisch/Ovarian_cancer/plots/stem_like/forest_plot_%s.pdf", saveres), width=15, height=5)
...
#### sig1 #########
cindex_summary <- combine.est(cindex_sum_sig1[dataSets != "tcga2011",1],cindex_sum_sig1[dataSets != "tcga2011",4])
...
#### sig2 ########
cindex_summary <- combine.est(cindex_sum_sig2[dataSets != "tcga2011",1],cindex_sum_sig2[dataSets != "tcga2011",4])
